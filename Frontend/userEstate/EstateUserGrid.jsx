...
export default class EstateUserGrid extends React.Component {
    constructor() {
        super()
        this.state = {
            pageOfItems: [],
                    ...
                    <div class="col-9" >
                        ...
                        <div class="row">
                            {this.state.pageOfItems.map((estate, i) =>
                                <div class="col-sm-4">
                                    <div class="card" id="estatecard" style={estateStyle.card}>
                                        <Link to={`DetailPage/${estate._id}`} style={estateStyle.textWrap}>
                                            <div>
                                                <div style={estateStyle.imgWrap}>
                                                    <img src={estate.imageUrl} alt="" style={estateStyle.img} />
                                                </div>
                                            </div>

                                            <div class="card-body">
                                                <div class="eName" style={estateStyle.title}><h5>{estate.title}</h5></div>
                                                <div class="ePrice" style={{ color: '#000' }}><h6><i class='indicator fa fa-dollar' ></i> {estate.price}</h6></div>
                                                <div class="eAddress" style={{ color: '#000' }}><h6><i class='indicator fa fa-map-marker' ></i> {estate.city} </h6></div>
                                                <div class="eInfo" style={{ fontSize: '14px' }}> {estate.area} m² | {estate.bedrooms} bedrooms |  {estate.floors} floors </div>
                                            </div>
                                        </Link>
                                        <div class="btn-group">
